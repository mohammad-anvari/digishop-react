...
const AboutUs = () => {
  ...
  return (
    <>
      <div className="w-full max-w-[1488px] h-[223.84] py-[32px] border-t-[1px] border-[#f0f0f1] flex items-start justify-between flex-nowrap ">
        <div className="grow ">
          <div
            className={` overflow-hidden relative text-[#81858b] me-[40px] ${
              button ? "h-auto" : "h-[125px]"
            } text-[.8rem] font-[400] leading-[2.1]`}
          >
            <h1
              className={`  font-bold text-[1.4rem] text-[#62666d] ${
                button ? null : `${style.bggradient}`
              }`}
            >
          ...
          {/* button */}
          <button
            className="flex items-center mt-[8px]  font-bold text-[#19bfd3] text-[.8rem]"
            onClick={clickHandler}
          >
            <span>{button ? "بستن" : "مشاهده بیشتر"}</span>
        ...
        <div className="   flex items-center justify-end">
          <div className=" p-[16px] border-[1px] border-[#e0e0e2] rounded-[8px] ms-[8px]">
            <div className="w-[75px] h-[75px]">
              <img
                src="../../../public/Image/footer/Aboutus/rezi.webp"
          ...
          <div className=" p-[16px] border-[1px] border-[#e0e0e2] rounded-[8px] ms-[8px]">
            <div className="w-[75px] h-[75px]">
              <img
                src="../../../public/Image/footer/Aboutus//kasbokar.webp"
                className="w-[75px] h-[75px]"
                alt=""
              />
            </div>
          ...
          <div className=" p-[16px] border-[1px] border-[#e0e0e2] rounded-[8px] ms-[8px]">
            <div className="w-[75px] h-[75px]">
              <img
                src="../../../public/Image/footer/Aboutus/logo.aspx"
                className="w-[75px] h-[75px]"
                alt=""
              />
            </div>
      ...
      <div className=" py-[32px] border-t-[1px] border-[#f0f0f1] flex items-center justify-center">
        <p className="text-[#81858b] text-[.8rem]">
